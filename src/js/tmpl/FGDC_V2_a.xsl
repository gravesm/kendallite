						...
						<DD>
							<DL>
								...
								<xsl:for-each select="dsgpoly">
									<DT>
										<I>Data_Set_G-Polygon:</I>
									</DT>
									<DD>
										<DL>
											<xsl:for-each select="dsgpolyo">
												<DT>
													<I>Data_Set_G-Polygon_Outer_G-Ring:</I>
												</DT>
												<DD>
													<DL>
											...
											<xsl:for-each select="dsgpolyx">
												<DT>
													<I>Data_Set_G-Polygon_Exclusion_G-Ring:</I>
												</DT>
												<DD>
													<DL>
														<xsl:apply-templates select="grngpoin"/>
						...
						<DD>
							<DL>
								...
								<xsl:for-each select="qattracc">
									<DT>
										<I>Quantitative_Attribute_Accuracy_Assessment:</I>
									</DT>
									<DD>
										<DL>
						...
						<DD>
							<DL>
									...
									<DD>
										<DL>
											...
											<xsl:for-each select="qhorizpa">
												<DT>
													<I>Quantitative_Horizontal_Positional_Accuracy_Assessment:</I>
												</DT>
												<DD>
													<DL>
								...
								<xsl:for-each select="vertacc">
									<DT>
										<I>Vertical_Positional_Accuracy:</I>
									</DT>
									<DD>
										<DL>
											...
											<xsl:for-each select="qvertpa">
												<DT>
													<I>Quantitative_Vertical_Positional_Accuracy_Assessment:</I>
												</DT>
												<DD>
													<DL>
									...
									<DD>
										<DL>
											...
											<xsl:for-each select="vpfinfo">
												<DT>
													<I>VPF_Point_and_Vector_Object_Information:</I>
												</DT>
												<DD>
													<DL>
												...
												<DD>
													<DL>
														...
														<xsl:for-each select="gvnsp">
															<DT>
																<I>General_Vertical_Near-sided_Perspective:</I>
															</DT>
														</xsl:for-each>
														...
														<xsl:for-each select="lamberta">
															<DT>
																<I>Lambert_Azimuthal_Equal_Area:</I>
															</DT>
														</xsl:for-each>
														...
														<xsl:for-each select="modsak">
															<DT>
																<I>Modified_Stereographic_for_Alaska:</I>
															</DT>
															<DD>
																<DL>
														...
														<xsl:for-each select="spaceobq">
															<DT>
																<I>Space_Oblique_Mercator_(Landsat):</I>
															</DT>
															<DD>
																<DL>
												...
												<DD>
													<DL>
														...
														<xsl:for-each select="utm">
															<DT>
																<I>Universal_Transverse_Mercator:</I>
															</DT>
															<DD>
																<DL>
														...
														<xsl:for-each select="ups">
															<DT>
																<I>Universal_Polar_Stereographic:</I>
															</DT>
															<DD>
																<DL>
														...
														<xsl:for-each select="spcs">
															<DT>
																<I>State_Plane_Coordinate_System:</I>
															</DT>
															<DD>
																<DL>
												...
												<DD>
													<DL>
														...
														<xsl:for-each select="distbrep">
															<DT>
																<I>Distance_and_Bearing_Representation:</I>
															</DT>
															<DD>
																<DL>
									...
									<DD>
										<DL>
											...
											<xsl:for-each select="attrvai">
												<DT>
													<I>Attribute_Value_Accuracy_Information:</I>
												</DT>
												<DD>
													<DL>
			...
			<DD>
				<DL>
					...
					<xsl:for-each select="metsi">
						<DT>
							<I>Metadata_Security_Information:</I>
						</DT>
						<DD>
							<DL>
